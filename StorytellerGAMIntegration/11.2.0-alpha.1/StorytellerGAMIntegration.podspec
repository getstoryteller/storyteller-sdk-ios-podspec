Pod::Spec.new do |s|
    ...
    s.source            = { :http => 'https://storyteller.azureedge.net/sdk-ios/xcframeworks/11.2.0-alpha.1/StorytellerGAMIntegration.zip' }

    s.ios.deployment_target = '13.0'
    s.swift_versions = ['4.2', '5.0', '5.1', '5.3']

    s.dependency 'Google-Mobile-Ads-SDK', '~> 12.6'
    s.dependency 'StorytellerSDK', '11.2.0-alpha.1'
