Pod::Spec.new do |s|
    ...
    s.source            = { :http => 'https://storyteller.azureedge.net/sdk-ios/cocoapods/4.5.3/StorytellerSDK.zip' }
    ...
    s.ios.vendored_frameworks = 'StorytellerSDK.framework' #the path of the framework you are distributing within the s.source archive, after being decompressed.
end
